...
public extension DesignKit {
    ...
    static func largeTitle() -> Font {
        .system(.largeTitle, design: DesignKit.current.configuration.typography.fontDesign, weight: .bold)
    }
    
    /// Title 1 style
    static func title() -> Font {
        .system(.title, design: DesignKit.current.configuration.typography.fontDesign, weight: .bold)
    }
    
    /// Title 2 style
    static func title2() -> Font {
        .system(.title2, design: DesignKit.current.configuration.typography.fontDesign, weight: .bold)
    }
    
    /// Title 3 style
    static func title3() -> Font {
        .system(.title3, design: DesignKit.current.configuration.typography.fontDesign, weight: .semibold)
    }
    
    /// Headline style
    static func headline() -> Font {
        .system(.headline, design: DesignKit.current.configuration.typography.fontDesign, weight: .semibold)
    }
    
    /// Body style
    static func body() -> Font {
        .system(.body, design: DesignKit.current.configuration.typography.fontDesign, weight: .regular)
    }
    
    /// Callout style
    static func callout() -> Font {
        .system(.callout, design: DesignKit.current.configuration.typography.fontDesign, weight: .regular)
    }
    
    /// Subheadline style
    static func subheadline() -> Font {
        .system(.subheadline, design: DesignKit.current.configuration.typography.fontDesign, weight: .semibold)
    }
    
    /// Footnote style
    static func footnote() -> Font {
        .system(.footnote, design: DesignKit.current.configuration.typography.fontDesign, weight: .medium)
    }
    
    /// Caption 1 style
    static func caption() -> Font {
        .system(.caption, design: DesignKit.current.configuration.typography.fontDesign, weight: .medium)
    }
    
    /// Caption 2 style
    static func caption2() -> Font {
        .system(.caption2, design: DesignKit.current.configuration.typography.fontDesign, weight: .regular)
    }
    ...
    static func timeDisplay() -> Font {
        .system(size: 28, weight: .bold, design: DesignKit.current.configuration.typography.fontDesign)
    }
    
    /// Ticker title font (18pt) - for ticker names
    static func tickerTitle() -> Font {
        .system(size: 18, weight: .semibold, design: DesignKit.current.configuration.typography.fontDesign)
    }
    
    /// Detail text font (15pt) - for schedule details
    static func detailText() -> Font {
        .system(size: 15, weight: .medium, design: DesignKit.current.configuration.typography.fontDesign)
    }
    
    /// Button text font (14pt) - for buttons and labels
    static func buttonText() -> Font {
        .system(size: 14, weight: .semibold, design: DesignKit.current.configuration.typography.fontDesign)
    }
    
    /// Small text font (12pt) - for secondary info
    static func smallText() -> Font {
        .system(size: 12, weight: .medium, design: DesignKit.current.configuration.typography.fontDesign)
    }
}
